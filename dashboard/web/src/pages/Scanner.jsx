...
export default function Scanner() {
  ...
  useEffect(() => {
    async function load() { setData(await api("/api/scan")); }
    load();
    ...
    <>
      ...
      <div className="card" style={{ marginBottom: "1rem" }}>
        ...
        <div className="row">
          ...
          {!data.ws_symbols.length && <span className="muted">None allocated yet — start the stream service</span>}
        </div>
      </div>
      <div className="card">
        <h3>Latest SCAN ranking</h3>
        <table>
          <thead>
